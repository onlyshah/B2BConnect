...
@Component({
  selector: 'app-super-admin-categories',
  standalone: true,
  ...
  template: `
    <section class="page-card">
      <div class="title-row">
        ...
        <button class="action-btn">New category</button>
      </div>
      <div class="list">
        <article class="item">
          <strong>Fresh foods</strong>
          <span>12 subcategories</span>
        </article>
      </div>
    </section>
  `,
...
export class SuperAdminCategoriesComponent {}
