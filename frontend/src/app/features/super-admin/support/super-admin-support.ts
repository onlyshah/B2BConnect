...
@Component({
  selector: 'app-super-admin-support',
  standalone: true,
  ...
  template: `
    <section class="page-card">
      <div class="title-row">
        ...
        <button class="action-btn">Open ticket</button>
      </div>
      <div class="list">
        <article class="item">
          <strong>Escalation: inventory sync</strong>
...
export class SuperAdminSupportComponent {}
