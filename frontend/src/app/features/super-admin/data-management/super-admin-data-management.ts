...
@Component({
  selector: 'app-super-admin-data-management',
  standalone: true,
  ...
  template: `
    <section class="page-card">
      <div class="title-row">
        ...
        <button class="action-btn">Sync now</button>
      </div>
      <div class="list">
        <article class="item">
          <strong>Tenant snapshot</strong>
          <span>Last sync 18 mins ago</span>
        </article>
      </div>
    </section>
  `,
...
export class SuperAdminDataManagementComponent {}
