...
@Component({
  selector: 'app-super-admin-advertisements',
  standalone: true,
  ...
  template: `
    <section class="page-card">
      <div class="title-row">
        <div>
          <p class="eyebrow">Promotion engine</p>
          <h2>Advertisements</h2>
        </div>
        <button class="action-btn">Launch campaign</button>
      </div>
      <div class="list">
        <article class="item">
          <strong>Spring promotion</strong>
          <span>Live • 4 segments</span>
        </article>
      </div>
    </section>
  `,
...
export class SuperAdminAdvertisementsComponent {}
