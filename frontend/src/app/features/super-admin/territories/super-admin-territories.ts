...
@Component({
  selector: 'app-super-admin-territories',
  standalone: true,
  ...
  template: `
    <section class="page-card">
      <div class="title-row">
        ...
        <button class="action-btn">Map territory</button>
      </div>
      <div class="list">
        <article class="item">
          <strong>North region</strong>
          <span>8 distributors</span>
        </article>
      </div>
    </section>
  `,
...
export class SuperAdminTerritoriesComponent {}
